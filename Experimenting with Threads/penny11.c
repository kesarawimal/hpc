/****************************************************************************
  This version adds 10000 coins to the account. The one millisecond delay 
  has been replaced by a shorter delay caused by a redundant for loop.
  
  Compile with:

    cc -o penny11 penny11.c time_diff.c -lrt -pthread 
...
//  loop 100 times to create 100 threads
  for(i=0;i<n;i++){
